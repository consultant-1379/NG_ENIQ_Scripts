...
function clone_chassis () {
  ...
  if [ ! -z "$git_version" ]; then
      ...
      cd demo && git checkout master && git archive HEAD | (cd ../ && tar xf -)
      cd .. && rm -rf demo
  else
...
function update_helm_properties() {
  ...
  mv charts/demo/templates/tests/demo-test.yaml charts/$helmChartNameVar/templates/tests/$helmChartNameVar-test.yaml
  sed -i "s/name:.*/name: $helmChartNameVar/g" charts/$helmChartNameVar/Chart.yaml
  sed -i "s+repoPath: REPO_PATH+repoPath: proj-eniq/proj-$helmChartNameVar-release+g" charts/$helmChartNameVar/values.yaml
  sed -i "s/name: IMAGE_NAME/name: $helmChartNameVar/g" charts/$helmChartNameVar/values.yaml

  sed -i "s/demo./$helmChartNameVar./g" charts/$helmChartNameVar/templates/NOTES.txt
  sed -i "s/demo./$helmChartNameVar./g" charts/$helmChartNameVar/templates/_helpers.tpl
  sed -i "s/demo./$helmChartNameVar./g" charts/$helmChartNameVar/templates/deployment.yaml
  sed -i "s/demo./$helmChartNameVar./g" charts/$helmChartNameVar/templates/ingress.yaml
  sed -i "s/demo./$helmChartNameVar./g" charts/$helmChartNameVar/templates/service.yaml
  sed -i "s/demo./$helmChartNameVar./g" charts/$helmChartNameVar/templates/tests/$helmChartNameVar-test.yaml
  sed -i "s/demo./$helmChartNameVar./g" charts/$helmChartNameVar/templates/hpa.yaml
  sed -i "s/demo./$helmChartNameVar./g" charts/$helmChartNameVar/templates/serviceaccount.yaml
  sed -i "s/demo./$helmChartNameVar./g" charts/$helmChartNameVar/templates/rolebinding.yaml
  sed -i "s/demo./$helmChartNameVar./g" charts/$helmChartNameVar/templates/podDisruptionbudget.yaml

  ##updating Zap Config.yaml
  sed -i "s/demo:/$helmChartNameVar:/g" zap/zap_config.yaml
  
  ##updating NMAP config.yaml
  sed -i "s/demo/$helmChartNameVar/g" nmap/nmap_config.yaml
  sed -i "s/demo/$helmChartNameVar/g" nmap/nmap_config_all_protocols.yaml
